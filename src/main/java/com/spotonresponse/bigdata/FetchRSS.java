...
public class FetchRSS {
    ...
    private static void processRss() throws IOException {
        ...
        JSONObject xmlJSONObj = new GetRssFeed().getFeed(url);


        // if this is a test and want to read a local file...
        //String xmlFileString = getRssFeed("file1.txt");
        //WriteFile(xmlFileString);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String amazon_endpoint = System.getenv("amazon_endpoint");
        String amazon_region = System.getenv("amazon_region");
